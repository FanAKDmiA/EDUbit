  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#f6f8f5] px-5 py-8 text-ink">
      <section className="w-full max-w-lg rounded-md border border-ink/10 bg-white p-6 text-center shadow-sm md:p-8">
        ...
        <p className="mt-5 text-sm font-bold uppercase tracking-[0.18em] text-mint">Recuperación de acceso</p>
        <h1 className="mt-3 text-3xl font-black">Olvidé mi contraseña</h1>
        <p className="mt-3 text-sm leading-6 text-ink/65">
          El circuito automático de recuperación se incorporará en la Iteración 1.1. Por ahora, solicitá a administración el reinicio de tu contraseña.
        </p>
